...
class UAP_Main{
	...
	*/
		 ...
		 */
		 ...
		 if (!empty($action)){
		 	...
		 	switch ($action){
				...
				case 'migrate':
					$params = array(
								'serviceType'   => isset($_POST['service_type']) ? esc_sql($_POST['service_type']) : false,
								'entityType'    => isset($_POST['entity_type']) ? esc_sql($_POST['entity_type']) : false,
								'offset'        => isset($_POST['offset']) ? esc_sql($_POST['offset']) : 0,
								'assignRank'    => isset($_POST['assignRank']) ? esc_sql($_POST['assignRank']) : false
					);
	...
	public static function uap_add_custom_top_menu_dashboard(){
		...
		$wp_admin_bar->add_menu(array('parent'=>'uap_dashboard_menu', 'id'=>'uap_dashboard_menu_offers', 'title'=>esc_html__('Offers', 'uap'), 'href'=>admin_url('admin.php?page=ultimate_affiliates_pro&tab=offers'), 'meta'=>array()));
		...
		$wp_admin_bar->add_menu(array('parent'=>'uap_dashboard_menu', 'id'=>'uap_dashboard_menu_general', 'title'=>esc_html__('General Options', 'uap'), 'href'=>admin_url('admin.php?page=ultimate_affiliates_pro&tab=settings'), 'meta'=>array()));
		$wp_admin_bar->add_menu(array('parent'=>'uap_dashboard_menu', 'id'=>'uap-pro-addons-link', 'title'=>'Pro AddOns', 'href'=>'https://store.wpindeed.com/addon/category/ultimate-affiliate-pro/', 'meta'=>array('target' => '_blank')));
		if (!uap_is_ihc_active()){
			$wp_admin_bar->add_menu(array('parent'=>'uap_dashboard_menu', 'id'=>'uap-ihc-link', 'title'=>'Ultimate Membership Pro', 'href'=>'https://wpindeed.com/ultimate-membership-pro', 'meta'=>array('target' => '_blank')));
		}

		/// SHOWCASES
		$wp_admin_bar->add_menu(array('parent'=>'uap_dashboard_menu_showcases', 'id'=>'uap_dashboard_menu_showcases_rf', 'title'=>esc_html__('Register Form', 'uap'), 'href'=>admin_url('admin.php?page=ultimate_affiliates_pro&tab=register'), 'meta'=>array()));
		...
		$wp_admin_bar->add_menu(array('parent'=>'uap_dashboard_menu_showcases', 'id'=>'uap_dashboard_menu_showcases_ap', 'title'=>esc_html__('Account Page', 'uap'), 'href'=>admin_url('admin.php?page=ultimate_affiliates_pro&tab=account_page'), 'meta'=>array()));
		...
		$array = array(
							...
							'uap_general_user_page' => esc_html__('User Account Page', 'uap'),
