...
if (!class_exists('UapMainPublic')){
	...
	class UapMainPublic{
		...
		public function __construct(){
			...
			add_action('user_register', array($this, 'all_new_users_become_affiliates'), 98, 1);
		...
		public function add_style_and_scripts(){
			...
			wp_enqueue_style( 'uap_public_style', UAP_URL . 'assets/css/main_public.min.css', array(), 7.4 );
			...
			//wp_register_script( 'uap-public-functions', UAP_URL . 'assets/js/public-functions.js', ['jquery'], 7.4 );

			wp_register_script( 'uap-public-functions', UAP_URL . 'assets/js/public-functions.min.js', ['jquery'], 7.5 );
			...
			wp_register_script( 'uap-jquery_form_module', UAP_URL . 'assets/js/jquery.form.js', ['jquery'], 7.4 );

			wp_register_script( 'uap-jquery.uploadfile', UAP_URL . 'assets/js/jquery.uploadfile.min.js', ['jquery'], 7.4 );

			wp_register_script( 'uap-public-dynamic', UAP_URL . 'assets/js/public.js', ['jquery'], 7.4  );
			 ...
			 */
			 ...
			 switch ($type){
				...
				case 'account_page':
					...
					$data['content'] = esc_html__('Affiliate Account Page!', 'uap');
			 ...
			 */
			 ...
			 if (get_option('uap_all_new_users_become_affiliates') && $uid && !defined('UAP_USER_REGISTER_PROCESS')){
				 ...
				 if (!empty($affiliate_id)){
					...
					//mohit
					if(isset($_POST['digits_reg_referralid']))
					{
