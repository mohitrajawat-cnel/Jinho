	...
	private function set_cookie($expire = 0, $shortcode_id = 0){
		 ...
		 */
		 ...
		 if ($expire && $shortcode_id){
			...
			<span class="uap-js-referral-landing-commisions-data" data-expire="<?php echo $expire;?>" data-shortcode_id="<?php echo $shortcode_id;?>"></span>

		 	<?php

			wp_enqueue_script( 'uap-referral-landing-commissions', UAP_URL . 'assets/js/referral-landing-commissions.js', ['jquery'], 7.4);
