        	...
        	<div class="uap-row ">
            	...
            	<div class="uap-col-xs-8">
                	...
                	<?php if (empty($data['print_username'])): ?>
						...
						<span><?php esc_html_e("Tracking ID:", 'uap');?></span> <span class=" uap-special-label"><?php echo ($data['affiliate_id'] + 60000);?></span>

					<?php else:?>

						<span><?php esc_html_e("Tracking Code:", 'uap');?></span> <span class=" uap-special-label"><?php echo $data['print_username'];?></span>
					...
					<?php
						...
						//mohit
						$explode_link = explode('?',$data['home_url']);
						$explode_ref = explode('=',$explode_link[1]);

						$new_ref_id_hwe = $explode_ref[1] + 60000;

						$ref_link_hwe = $explode_link[0].'?ref='.$new_ref_id_hwe;

					?>

        				<span><?php esc_html_e("Default Affiliate Link:", 'uap');?></span> <span class=" uap-special-label"><a href="<?php echo $ref_link_hwe;?>" target="_blank"><?php echo $ref_link_hwe;?></a></span>
                ...
                <div class="uap-col-xs-4">
                	...
                	<?php if (!empty($data['qr_home'])):?>
                      ...
                      <div class="uap-qr-code-wrapper uap-account-affiliatelinks-tab3">
                          ...
                          <a href="<?php echo $data['qr_home'];?>" class="uap-button-primary" download="<?php echo basename($data['qr_home']);?>"><?php esc_html_e('Download', 'uap');?></a>
        	...
        	<div class="uap-row ">
            	...
            	<div class="uap-col-xs-8">
                    ...
                    <div class="uap-account-affiliatelinks-tab7">
        				...
        				<span><?php esc_html_e("Alternative Slug Link:", 'uap');?></span> <span class=" uap-special-label"><a href="<?php echo $data['home_url_slug'];?>" target="_blank"><?php echo $data['home_url_slug'];?></a></span>
                ...
                <div class="uap-col-xs-4">
                	...
                	<?php if (!empty($data['qr_custom_slug'])):?>
                      ...
                      <div class="uap-qr-code-wrapper uap-account-affiliatelinks-tab4">
                          ...
                          <a href="<?php echo $data['qr_custom_slug'];?>" class="uap-button-primary" download="<?php echo basename($data['qr_custom_slug']);?>"><?php esc_html_e('Download', 'uap');?></a>
...
<?php do_action( 'uap_public_action_account_page_affiliate_links_after_content' );?>
    ...
    <div class="uap-profile-box-wrapper">
    	...
    	<div class="uap-profile-box-title"><span><?php esc_html_e("Link Generator", 'uap');?></span></div>
            	...
            	<div class="uap-col-xs-12">
                	...
                	<div class="uap-account-link-generator uap-account-affiliatelinks-tab5">
                      ...
                      <div class="uap-ap-field">
                          ...
                          <button type="button" class="uap-button-primary" onClick="iaGenerateLink(<?php echo $data['affiliate_id'];?>);"><?php esc_html_e("Generate Link", 'uap');?></button>
    ...
    <!--div class="uap-account-alert-warning uap-account-affiliatelinks-tab1">
		...
		<?php if (empty($data['print_username'])): ?>
			...
			<label class="uap-ap-label"><?php esc_html_e("Your Affiliate ID is:", 'uap');?></label> <strong class=" uap-special-label"><?php echo $data['affiliate_id'];?></strong>

		<?php else:?>

			<label class="uap-ap-label"><?php esc_html_e("Your Affiliate Name is:", 'uap');?></label> <strong class=" uap-special-label"><?php echo $data['print_username'];?></strong>
	...
	<?php if (!empty($data['qr_home'])):?>
		...
		<div class="uap-qr-code-wrapper uap-account-affiliatelinks-tab3">
			...
			<a href="<?php echo $data['qr_home'];?>" class="uap-qr-code-download" download="<?php echo basename($data['qr_home']);?>"><?php esc_html_e('Download', 'uap');?></a>
	...
	<?php if (!empty($data['home_url_slug'])):?>
		...
		<?php if (!empty($data['qr_custom_slug'])):?>
			...
			<div class="uap-qr-code-wrapper uap-account-affiliatelinks-tab4">
				...
				<a href="<?php echo $data['qr_custom_slug'];?>" class="uap-qr-code-download" download="<?php echo basename($data['qr_custom_slug']);?>"><?php esc_html_e('Download', 'uap');?></a>
	...
	<div><?php echo $data['social_links'];?></div>
  ...
  <div class="uap-account-link-generator uap-account-affiliatelinks-tab5">
	...
	<div class="uap-ap-field">
		...
		<button type="button" onClick="iaGenerateLink(<?php echo $data['affiliate_id'];?>);"><?php esc_html_e("Generate Link", 'uap');?></button>
