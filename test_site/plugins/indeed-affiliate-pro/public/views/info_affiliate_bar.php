...
<div id="uap_info_affiliate_bar" class="uap-info-affiliate-bar-wrapper">
    ...
    <?php if ( $data['settings']['uap_info_affiliate_bar_links_section_enabled'] ): ?>
            ...
            <span class="uap-display-none" id="uap_js_iab_linkts_triggers_section_data"><?php echo $data['links_section'];?></span>
    <?php endif;?>
...
<span class="uap-display-none" id="uap_js_iab_banner_section_data"><?php echo $data['bannerSection'];?></span>
    ...
    <?php if ( $data['settings']['uap_info_affiliate_bar_menu_section_enabled'] ):?>
          <div class="uap-info-affiliate-bar-btn uap-info-affiliate-bar-btn-default"
                      ...
                      data-content="
                        <ul>
                          <li><a href='<?php echo $data['profile_permalink'];?>' target='_blank'><?php echo esc_html__('Your Profile', 'uap'); ?></a></li>
                          <li><a href='<?php echo $data['settings_permalink'];?>' target='_blank'><?php echo esc_html__('Extra Settings', 'uap'); ?></a></li>
                          <li><a href='<?php echo $data['tips_permalink'];?>'  target='_blank'><?php echo esc_html__('Learn more', 'uap'); ?></a></li>
                        </ul>
