...
//mohit set_cokkie
		...
		protected function set_cookie($affiliate_id=0, $campaign='', $referral_hash='', $visit_id=0){
			...
			$data['site_referer'] = (empty($_SERVER['HTTP_REFERER'])) ? 'http://jackg103.sg-host.com?ref='.$affiliate_id : $_SERVER['HTTP_REFERER'];
			...
			setcookie($this->cookie_name, serialize($data), $cookie_time, $path); /// name, value, expire, path
