...
if (!class_exists('UapMainAdmin')){
	...
	class UapMainAdmin{
		...
		public function add_style_scripts(){
			...
			wp_register_script('uap_admin_js', UAP_URL . 'assets/js/admin-functions.min.js', ['jquery'], 7.6   );
			...
			if ( $pagenow == 'plugins.php' ){
					...
					wp_enqueue_script( 'indeed_sweetalert_js', UAP_URL . 'assets/js/sweetalert.js', ['jquery'], 2 );
			...
			if ($is_plugin_page){
				...
				wp_register_script('uap_public', UAP_URL . 'assets/js/public-functions.min.js', ['jquery'], 7.5   );
