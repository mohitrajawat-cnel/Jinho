<form  method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('Wallet', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/wallet/" target="_blank"><?php esc_html_e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
					...
					<div class="input-group">
						...
						<div>
								<?php
									...
									<div>
										<input type="checkbox" <?php echo (in_array($key, $temp)) ? 'checked' : '';?> onClick="uapMakeInputhString(this, '<?php echo $key;?>', '#uap_wallet_exclude_sources');" /> <?php echo $value;?>
									</div>
								<?php endforeach;?>
						</div>
