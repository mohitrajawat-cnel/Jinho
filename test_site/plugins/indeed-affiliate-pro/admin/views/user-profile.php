                          ...
                          <div class="row">
                           ...
                           <?php if ( $data['ranking_possition'] > -1 ):?>
                           		<div class="uap-userprofile-top-wrapper">
                                		<img src="<?php echo UAP_URL;?>assets/images/uap_trophy.png" alt="<?php echo $data['ranking_possition'];?>"/>
                            ...
                            <div class="uap-userprofile-links">
                            	<span class="uap-userprofile-links-label"><?php esc_html_e( "Affiliate Link", 'uap' );?>: </span><a href="<?php echo $data['affiliate_link'];?>" target="_blank"><?php echo $data['affiliate_link'];?></a> <span class="js-uap-copy uap-userprofile-copyclipboard"><?php esc_html_e( 'Copy to Clipboard', 'uap' );?></span> <div class="div-notice"><?php esc_html_e( '(for testing purpose use the affiliate link into a fresh incognito browser window)', 'uap' );?></div>
                            </div>
                            <div class="uap-userprofile-links">
                            	<span class="uap-userprofile-links-label"><?php esc_html_e( "Affiliate ID", 'uap' );?>: </span><?php echo $data['affiliate_id']; ?>
                            </div>
                            <?php if ( $data['custom_slug'] ):?>
                                <div class="uap-userprofile-links">
                                	<span class="uap-userprofile-links-label"><?php esc_html_e( "Custom Slug", 'uap' );?>: </span><?php echo $data['custom_slug'];?>
                                </div>
                            <?php endif;?>
                                ...
                                <div class="col-xs-5">
                                    <div class="uap-userprofile-rank uap-nextrank">
                                        ...
                                        <?php if ( $data['next_rank_data']['amount_type'] == 'percentage' ){
                                          echo $data['next_rank_data']['amount_value'].'%';
                                        }else{
                    	...
                    	<div class="uap-userprofile-profiledetails">
                            ...
                            <div class="col-xs-3">
                                  ...
                                  <?php if ( !empty( $data['avatar'] ) ):?>
                                      <img src="<?php echo $data['avatar'];?>" class="uap-avatar" alt="<?php echo $data['user_name'];?>" />
                                  <?php endif;?>
                                  </div>
                            </div>
                            <div class="col-xs-9">
                        	<table class="form-table">
                            	<tbody>
                                   ...
                                   $affiliate_id_hwe =$_REQUEST['affiliate_id'];
                                   $results = $wpdb->get_results("SELECT * from ".$wpdb->prefix."uap_affiliates where id='$affiliate_id_hwe'");
                                   foreach($results as $results_hwe)
                                   {
                                       $user_id  =$results_hwe->uid;
                                   }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span style="font-size:20px;font-weight:bold;">MYR<?php echo round($total_amount_wallet, 2); ?></span>
                                    ...
                                    <th><label for="postalcode"><?php _e("Charity Wallet"); ?></label></th>
                                        <td>
                                            <span style="font-size:16px;font-weight:bold;">MYR<?php echo round($charity_money, 2); ?></span><br />
                                        </td>
                                    </tr> -->
                                    <tr>
                                        <form method="post">
                                            <th>
                                                <label for="transfer-money"><?php _e("Transfer money from withdrawal wallet to charity wallet"); ?></label>
                                            </th>
                                            <td>
                                                <input type="number" name="transfer_money" id="">
                                            </td>
                                            <td>
                         ...
                         <div class="uap-userprofile-stats">
                            	...
                            	<tbody>
                                	<tr class="form-field">
                                        ...
                                        <td>
                                        	<div><?php esc_html_e( 'Verified:', 'uap' );?>: <?php echo $data['referrals_stats']['verified_referrals'];?> (<?php echo uap_format_price_and_currency( $data['currency'], $data['referrals_stats']['verified_referrals_amount'] );?>)</div>
                                        	<div><?php esc_html_e( 'UnVerified:', 'uap' );?>: <?php echo $data['referrals_stats']['unverified_referrals'];?> (<?php echo uap_format_price_and_currency( $data['currency'], $data['referrals_stats']['unverified_referrals_amount'] );?>)</div>
                                        </td>
                                    </tr>
                                    <tr class="form-field">
                                    ...
                                    <tr class="form-field">
                                    	<th>
                                        	<div><?php esc_html_e( 'Visits', 'uap' );?></div>
                                        ...
                                        <td>
                                        	<div><?php esc_html_e( 'Conversion:', 'uap' );?>: <?php echo $data['stats']['conversions'];?></div>
                                        	<div><?php esc_html_e( 'Success Rate:', 'uap' );?>: <?php echo $data['stats']['success_rate'];?>%</div>
                                        </td>
                                    </tr>
                                    <tr class="form-field">
                                    	<th>
                                        ...
                                        <td>
                                        	<div><?php esc_html_e( 'Completed Transactions:', 'uap' );?>: <?php echo $data['count_payments_completed'];?></div>
                                        	<div><?php esc_html_e( 'Pending Transactions:', 'uap' );?>: <?php echo $data['count_payments_pending'];?></div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                          ...
                          <tr class="form-field">
                              ...
                              <td>
                                  <?php switch( $data['payments_settings']['uap_affiliate_payment_type'] ){
                                          case 'bt':?>
                                          <?php esc_html_e( 'Bank Transfer', 'uap' );?>
                                        <?php break;
                                          case 'paypal':?>
                                        ...
                                        <?php break;
                                          case 'stripe_v2':?>
                                            <?php esc_html_e( 'Stripe V2', 'uap' );?>
                                        <?php break;?>
                                        <?php case 'stripe_v3':?>
                                        <?php esc_html_e( 'Stripe V3', 'uap' );?>
                                      <?php break;?>
                                  <?php }?>
                              </td>
                          </tr>
                                        ...
                                        $accountId = get_user_meta( $data['uid'], 'uap_stripe_v3_user_account_id', true );
                            						if ( $accountId != false && $accountId != '' ):
                            							...
                            							<div class="uap-payment-details-do-payment">
                            									<a href="<?php echo $stripe_link;?>" target="_blank"><?php
                        ...
                        <table class="form-table">
                          <tbody>
                              <?php foreach ( $data['campaigns'] as $campaignObject ):?>
                                  <tr class="form-field">
                                      <th width="40%" class="uap-text-align-center"><?php echo $campaignObject->name;?></th>
                                      <td width="20%"><?php esc_html_e('Visists: ', 'uap');?><?php echo $campaignObject->visit_count;?></td>
                                      <td width="20%"><?php esc_html_e('Unique visits: ', 'uap');?><?php echo $campaignObject->unique_visits_count;?></td>
                                      <td width="20%"><?php esc_html_e('Referrals: ', 'uap');?><?php echo $campaignObject->referrals;?></td>
                                  </tr>
                              <?php endforeach;?>
                          </tbody>
                        </table>
                      ...
                      <div class="col-xs-4 uap-userprofile-box">
                          ...
                          <ul class="uap-userprofile-list">
                              <?php foreach ( $data['coupons'] as $couponData ):?>
                                  ...
                                  <span class='uap-js-delete-coupons-link uap-delete-span' data-id='<?php echo $couponData['id'];?>' ><?php esc_html_e( 'Delete', 'uap' );?></span>
                                  </li>
                              <?php endforeach;?>
                      ...
                      <div class="col-xs-4 uap-userprofile-box">
                              ...
                              <ul class="uap-userprofile-list">
                                <?php foreach ( $data['referrer_links'] as $referrerLinks ):?>
                                     <li><a href="<?php echo $referrerLinks['url'];?>" target="_blank"><?php echo $referrerLinks['url'];?></a> - <span class='uap-js-delete-referrals-link uap-delete-span' data-id='<?php echo $referrerLinks['id'];?>' ><?php esc_html_e( 'Delete', 'uap' );?></span></li>
                                <?php endforeach;?>
                              </ul>
                      </div>
                  <?php endif;?>
                      ...
                      <div class="col-xs-4 uap-userprofile-box">
                            ...
                            <ul class="uap-userprofile-list">
                              <?php foreach ( $data['landing_pages'] as $landingPage ):?>
                            	     <li><a href="<?php echo get_permalink($landingPage->ID);?>" target="_blank"><?php echo $landingPage->post_title;?></a> - <a href="<?php echo admin_url('post.php?post='.$landingPage->ID.'&action=edit');?>" target="_blank"><?php esc_html_e( 'Edit', 'uap' );?></a> |
                                        <span class='uap-js-delete-landing-page uap-delete-span' data-id='<?php echo $landingPage->ID;?>' ><?php esc_html_e( 'Delete', 'uap' );?></span>
                                   </li>
                              <?php endforeach;?>
                            </ul>
                      </div>
